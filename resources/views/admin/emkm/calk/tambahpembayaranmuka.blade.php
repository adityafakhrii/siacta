...
<title>Tambah Pembayaran Dimuka | SIACTA</title>
        ...
        <div class="content-wrapper">
          <div class="row grid-margin">
            <div class="col-12"> 
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Tambah Pembayaran Dimuka</h4>
                  <form class="forms-sample" action="/emkm/calk/tambah-pembayaranmuka/store" method="post">
                    @csrf
                    <div class="form-group">
                      <label for="nama">Pilih Akun Pembayaran Dimuka</label>
