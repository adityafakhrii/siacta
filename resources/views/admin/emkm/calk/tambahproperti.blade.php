...
<title>Tambah Properti Investasi | SIACTA</title>
        ...
        <div class="content-wrapper">
          <div class="row grid-margin">
            <div class="col-12">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Tambah Properti Investasi</h4>
                  <form class="forms-sample" action="/emkm/calk/tambah-properti/store" method="post">
                    @csrf
