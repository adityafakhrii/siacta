...
<title>Tambah Aset Tidak Berwujud | SIACTA</title>
        ...
        <div class="content-wrapper">
          <div class="row grid-margin">
            <div class="col-12">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Tambah Aset Tidak Berwujud</h4>
                  <form class="forms-sample" action="/emkm/calk/tambah-aset-tidakberwujud/store" method="post">
                    @csrf
