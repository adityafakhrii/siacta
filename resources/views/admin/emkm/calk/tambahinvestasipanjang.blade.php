...
<title>Tambah Investasi Jangka Panjang | SIACTA</title>
        ...
        <div class="content-wrapper">
          <div class="row grid-margin">
            <div class="col-12">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Tambah Investasi Jangka Panjang</h4>
                  <form class="forms-sample" action="/calk/tambah-investasi-panjang/store" method="post">
                    @csrf
