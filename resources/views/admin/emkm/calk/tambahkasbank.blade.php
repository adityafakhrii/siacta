...
<title>Tambah Kas & Bank | SIACTA</title>
        ...
        <div class="content-wrapper">
          <div class="row grid-margin">
            <div class="col-12"> 
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Tambah Kas & Bank</h4>
                  <form class="forms-sample" action="/emkm/calk/tambah-kas-bank/store" method="post">
                    @csrf
                    <div class="form-group">
                      <label for="nama">Pilih Akun Kas</label>
