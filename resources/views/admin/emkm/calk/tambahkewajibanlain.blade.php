...
<title>Tambah Kewajiban Lain-lain | SIACTA</title>
        ...
        <div class="content-wrapper">
          <div class="row grid-margin">
            <div class="col-12"> 
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Tambah Kewajiban Lain-lain</h4>
                  <form class="forms-sample" action="/emkm/calk/tambah-kewajiban-lain/store" method="post">
                    @csrf
