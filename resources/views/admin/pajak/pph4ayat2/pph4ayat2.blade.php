...
<title>PPh Pasal 4 Ayat 2 | SIACTA</title>
@section('content')
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  @endif
                  <h4 class="card-title">PPh Pasal 4 Ayat 2</h4>
                  <a href="/pph4ayat2/tambah" class="btn btn-sm btn-primary btn-icon-text">
