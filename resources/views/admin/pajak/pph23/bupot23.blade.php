...
<title>Bukti Potong PPh 23 | SIACTA</title>
@section('content')
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <h4 class="card-title">Bukti Potong PPh 23</h4>
                  <a href="/pph23/bukti-potong/tambah" class="btn btn-sm btn-primary btn-icon-text">
