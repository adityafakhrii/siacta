...
<title>Bukti Potong PPh 21 Tidak Tetap | SIACTA</title>
@section('content')
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <h4 class="card-title">Bukti Potong PPH 21 Tidak Tetap</h4>
                  <a href="/pph21/bukti-potong-tidaktetap/tambah" class="btn btn-sm btn-primary btn-icon-text">
