...
class EMKMposisikeuanganController extends Controller
{
    ...
    public function PDF()
    {
        ...
        $PDF = PDF::loadView('admin.emkm.posisikeuangan.posisikeuanganpdf',compact('asetlancar','asettetapdebit','asettetapkredit','asettidakberwujud','kewajiban','ekuitas','total_labarugi','saldolaba','saldorugi'));

        return $PDF->stream('Laporan Neraca BUMDes Sauyunan - SIACTA.pdf');
    }
    ...
    public function PDFlogin()
    {
        ...
        $PDF = PDF::loadView('admin.emkm.posisikeuangan.posisikeuanganpdflogin',compact('asetlancar','asettetapdebit','asettetapkredit','asettidakberwujud','kewajiban','ekuitas','total_labarugi','saldolaba','saldorugi'));

        if (auth()->user()->role == 'unitusaha') {
                return $PDF->stream('Laporan Posisi Keuangan PAMDes Sauyunan - SIACTA.pdf');
        }else{
                return $PDF->stream('Laporan Neraca BUMDes Sauyunan - SIACTA.pdf');
        }
