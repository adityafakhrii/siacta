...
class PerubahanekuitasController extends Controller
{
    ...
    public function PDF()
    {
        ...
        $PDF = PDF::loadView('admin.etap.ekuitas.ekuitaspdf',compact('modal_awal','tambahan_modal','total_labarugi','prive'));

        return $PDF->stream('Laporan Perubahan Ekuitas BUMDes Sauyunan - SIACTA.pdf');
    }
}
